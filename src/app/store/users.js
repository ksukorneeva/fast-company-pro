...
const { usersRequested, usersReceived, usersRequestField, authRequestSuccess, authRequestFailed, userCreated, userLoggedOut, userUpdateSuccessed } = actions;
...
export const getIsLoggetIn = () => state => state.users.isLoggedIn;
